	...
	public String processInput(String theInput) {
		...
		if (theInput.indexOf("GET") != 0) {
			...
			if (fileExt.compareToIgnoreCase("class") == 0) {
				...
				try {
					Class<?> cls = Class.forName("servlets." + fileName.substring(0, fileName.indexOf(".")));
					Object servletInstance = cls.newInstance();
					Method servletMethodSDG = servletInstance.getClass().getMethod("sampleDoGet");
					String result = (String) servletMethodSDG.invoke(servletInstance, null);
